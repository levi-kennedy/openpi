    ...
    for topic, msg, t in reorder_bag_timestamps(reader, time_source=time_source):
        ...
        if topic == "/wrist_camera/image_raw":
            ...
            if joint_reordering is None:
                ...
                joint_reordering = [
                    _msg.name.index("shoulder_pan_joint"),
                    _msg.name.index("shoulder_lift_joint"),
                    _msg.name.index("elbow_joint"),
                    _msg.name.index("wrist_1_joint"),
                    _msg.name.index("wrist_2_joint"),
                    _msg.name.index("wrist_3_joint"),
