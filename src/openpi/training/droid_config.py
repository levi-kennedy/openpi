...
_CONFIGS = [
    ...
    TrainConfig(
        ...
        # LoRA uses much less memory; batch size 8 is a safe default for 24GB.
        batch_size=8,
    ...
    TrainConfig(
        ...
        data=SimpleDataConfig(
            # Load normalization stats computed for this config (see scripts/compute_norm_stats.py).
            assets=AssetsConfig(),
        ...
        # Initialize from the pi0-FAST base checkpoint. You can switch to the DROID expert checkpoint
        # or a local path to continue fine-tuning from a different starting point.
        weight_loader=weight_loaders.CheckpointWeightLoader("s3://openpi-assets/checkpoints/pi0_fast_base/params"),
        num_train_steps=20_000,
    ),
    #
